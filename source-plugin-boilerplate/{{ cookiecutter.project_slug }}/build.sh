...
# This file is automatically run by georiva when the plugin is built into a Dockerfile.
...
# Any install steps that will modify things in georiva's data volume should instead
...
# georiva will automatically install this python module for you so you should not
